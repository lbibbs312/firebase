...
class AppColors {
  ...
  // Light-mode panel/card background
  static const cardLight = Color(0xFFF8FAFD); // Explicitly defined as per suggestion
  ...
  // --- New Dark Gray Theme Colors (incorporating cardDark) ---
  static const darkGreyUI = Color(0xFF2E2E2E); // main background, drawers, sidebars
  static const darkerGreyUI = Color(0xFF262626); // app bars
  static const midGreyUI = Color(0xFF3A3A3A); // used for cards, panels
  static const lightOnDarkUIText = Colors.white70; // text and icon color

  // Dark-mode panel/card background
  static const Color cardDark  = midGreyUI; // Using midGreyUI as suggested

  // --- Original Dark Mode Colors (kept for reference, can be cleaned up if new theme fully replaces it) ---
  static const accentDeniedDark = Color(0xFF8D3650);
  static const accentAffirmativeDark = Color(0xFF3E8463);
  static const accent4Dark = Color(0xFFBBA7C4);
  static const accent5Dark = Color(0xFF87B1AA);
  static const newChatDark = Color(0xFF8BE0D1);
  static const adjustedPrimaryDark = Color(0xFF22A2A2);
  static const primaryDark = Color(0xFF128787);
  static const ultraWhiteDark = Color(0xFFFFFFFF);
  static const whiteFillDark = Color(0xFFFFFFFF);
  ...
  // static const cardDarkOriginal = Color(0xFF292B33); // This was the previous name, replaced by cardDark using midGreyUI
  ...
  static const logsBarStrokeDark = Color(0xFF121419);
